		...
		<div class="card-body card-block" >
			<form action="{{ route('students.process_update_students',['id'=>$students->id]) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9"><input type="email" id="email-input" name="email" placeholder="Nhập Email" class="form-control" value="{{ $students->email }}" readonly="readonly">{{ $errors->first('email') }}</div>
				</div>
				{{-- <div class="row form-group">
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9"><input type="text" id="password-input" name="address" placeholder="Địa chỉ" class="form-control" value="{{ $students->address }}">{{ $errors->first('<address>

		...
		<div class="card-body card-block" >
			<form action="{{ route('teacher.process_insert_teacher') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9"><input type="text" id="text-input" name="last_name" placeholder="Text" class="form-control" value="{{ old('old_name') }}">{{ $errors->first('old_name') }}</div>
				</div>
				<div class="row form-group">
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9"><input type="password" id="password-input" name="password" placeholder="Password" class="form-control" class="form-control" value="{{ old('pass') }}">{{ $errors->first('password') }}</div>
				</div>
